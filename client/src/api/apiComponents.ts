...
export const fetchEvaluate = (variables: EvaluateVariables, signal?: AbortSignal) =>
  apiFetch<EvaluateResponse, EvaluateError, undefined, {}, {}, EvaluatePathParams>({
...
export const useEvaluate = (
  options?: Omit<
    reactQuery.UseMutationOptions<EvaluateResponse, EvaluateError, EvaluateVariables>,
    "mutationFn"
  >
) => {
  const { fetcherOptions } = useApiContext()
  return reactQuery.useMutation<EvaluateResponse, EvaluateError, EvaluateVariables>({
...
export const fetchGenerateTestCases = (
  ...
  apiFetch<GenerateTestCasesResponse, GenerateTestCasesError, Schemas.GenParams, {}, {}, {}>({
