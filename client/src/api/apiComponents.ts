...
export type EvaluateResponse = {
  [key: string]: Schemas.EvaluateSummary;
};
...
export const fetchEvaluate = (
  ...
  apiFetch<
    ...
    {},
    EvaluatePathParams
  >({ url: "/evaluate/{promptId}", method: "post", ...variables, signal });
...
export const fetchPostAiFunction = (
  ...
  apiFetch<
    ...
    {},
    {}
  >({ url: "/ai-function", method: "post", ...variables, signal });
...
export const fetchDeleteAiFunction = (
  variables: DeleteAiFunctionVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    Schemas.SuccessResponse,
...
export const fetchPatchAiFunction = (
  variables: PatchAiFunctionVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    Schemas.AIFunction,
...
export const fetchPostPrompt = (
  ...
  apiFetch<
    ...
    {},
    {}
  >({ url: "/prompt", method: "post", ...variables, signal });
...
export const fetchDeletePrompt = (
  ...
  >({ url: "/prompt/{promptId}", method: "delete", ...variables, signal });
...
export const fetchPatchPrompt = (
  variables: PatchPromptVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    Schemas.Prompt,
...
export const fetchGetPrompts = (
  ...
  >({ url: "/prompts/{aiFunctionId}", method: "get", ...variables, signal });
...
export const fetchGetAllPrompts = (
...
export const useGetAllPrompts = <TData = GetAllPromptsResponse,>(
  ...
  return reactQuery.useQuery<GetAllPromptsResponse, GetAllPromptsError, TData>({
    ...
    queryFn: ({ signal }) =>
      fetchGetAllPrompts({ ...fetcherOptions, ...variables }, signal),
    ...options,
    ...queryOptions,
  });
};
...
export const fetchPostProject = (
  variables: PostProjectVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    Schemas.Project,
    PostProjectError,
    Schemas.ProjectRouteInput,
    {},
    {},
    {}
...
export const fetchGetProject = (
  ...
  >({ url: "/project/{projectId}", method: "get", ...variables, signal });
...
export const useGetProject = <TData = Schemas.Project,>(
  ...
  return reactQuery.useQuery<Schemas.Project, GetProjectError, TData>({
    ...
    queryFn: ({ signal }) =>
      fetchGetProject({ ...fetcherOptions, ...variables }, signal),
    ...options,
    ...queryOptions,
  });
};
...
export const fetchDeleteProject = (
...
export const fetchPatchProject = (
  variables: PatchProjectVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    Schemas.Project,
...
export const fetchGetProjectApiDocs = (
  ...
  apiFetch<
    Schemas.OpenAPI,
    GetProjectApiDocsError,
    undefined,
    {},
    {},
    GetProjectApiDocsPathParams
  >({
...
export const useGetProjectApiDocs = <TData = Schemas.OpenAPI,>(
  ...
  return reactQuery.useQuery<Schemas.OpenAPI, GetProjectApiDocsError, TData>({
    ...
    queryFn: ({ signal }) =>
      fetchGetProjectApiDocs({ ...fetcherOptions, ...variables }, signal),
    ...options,
    ...queryOptions,
  });
};
...
export const useExecute = (
  ...
  return reactQuery.useMutation<
    ...
    ExecuteVariables
  >({
    mutationFn: (variables: ExecuteVariables) =>
      fetchExecute({ ...fetcherOptions, ...variables }),
    ...options,
  });
};
...
export type GenerateTestCasesResponse = Schemas.GenTestCase[];

export type GenerateTestCasesVariables = {
  body: Schemas.GenParams;
} & ApiContext["fetcherOptions"];
...
export const fetchGenerateTestCases = (
  ...
  apiFetch<
    ...
    {},
    {}
  >({ url: "/generate/test-cases", method: "post", ...variables, signal });
...
export type GeneratePromptMessagesError = Fetcher.ErrorWrapper<
  | {
      status: 400;
      payload: Schemas.HttpExceptionModel;
    }
...
export type GeneratePromptMessagesResponse = Schemas.GenPromptMessage[];

export type GeneratePromptMessagesVariables = {
  body: Schemas.GenParams;
} & ApiContext["fetcherOptions"];

export const fetchGeneratePromptMessages = (
  variables: GeneratePromptMessagesVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    GeneratePromptMessagesResponse,
    GeneratePromptMessagesError,
    Schemas.GenParams,
    {},
    {},
    {}
  >({ url: "/generate/prompt-messages", method: "post", ...variables, signal });

export const useGeneratePromptMessages = (
  options?: Omit<
    reactQuery.UseMutationOptions<
      GeneratePromptMessagesResponse,
      GeneratePromptMessagesError,
      GeneratePromptMessagesVariables
    >,
    "mutationFn"
  >,
) => {
  ...
  return reactQuery.useMutation<
    ...
    GeneratePromptMessagesVariables
  >({
    mutationFn: (variables: GeneratePromptMessagesVariables) =>
      fetchGeneratePromptMessages({ ...fetcherOptions, ...variables }),
    ...options,
  });
};
